              ...
              <div className="w-[280px] h-[580px] bg-gray-900 rounded-[3rem] p-3 shadow-2xl">
                <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    {/* List items */}
                    {[
                      { name: "Birthday Wishlist", count: 12, icon: <svg className="w-6 h-6 text-pink-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 15.999h-2.316l.149-5.218A6.834 6.834 0 0012 4.012a6.834 6.834 0 00-6.833 6.769l.149 5.218H3a1 1 0 00-1 1v2a1 1 0 001 1h18a1 1 0 001-1v-2a1 1 0 00-1-1zM12 4v3M8 4c0 2.5 4 3 4 3s4-.5 4-3" /></svg> },
                      { name: "Christmas 2026", count: 8, icon: <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 2l3 5h-2l3 5h-2l3 6H7l3-6H8l3-5H9l3-5zM12 22v-4" /></svg> },
                      { name: "Home Office", count: 5, icon: <svg className="w-6 h-6 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg> },
                    ].map((list, i) => (
                      <div
                        key={i}
